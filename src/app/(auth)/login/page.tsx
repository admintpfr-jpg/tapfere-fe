      ...
      <div className="relative h-full w-full flex flex-col justify-center bg-white border-l border-gray-100 shadow-[inset_0_0_100px_rgba(0,0,0,0.02)]">
        <div className="max-w-md w-full mx-auto px-8 sm:px-12">
          ...
          <button 
            ...
            className="w-full py-4 px-4 bg-white hover:bg-gray-50 border border-gray-200 hover:border-blue-300 rounded-xl flex items-center justify-center gap-3 transition-all duration-200 shadow-sm hover:shadow-md mb-8 group"
          >
            ...
            <span className="font-semibold text-gray-700 text-[15px] tracking-wide select-none group-hover:text-blue-700 transition-colors">
